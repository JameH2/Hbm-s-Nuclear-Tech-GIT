...
public class HazardRegistry {
	...
	public static void registerItems() {
		...
		HazardSystem.register(new ItemStack(ModBlocks.bobblehead, 1, 22), makeData(ASBESTOS, 1F)); //this works okay

		HazardSystem.register(new ItemStack(ModBlocks.bobblehead, 1, 25), makeData(GLITCH, 1F));

		HazardSystem.register(new ItemStack(ModItems.full_drive, 1, SolarSystem.Body.DIMA.ordinal()), makeData(GLITCH, 1F));
