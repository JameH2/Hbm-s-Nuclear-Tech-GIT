...
public class ModEventHandlerRenderer {
	...
	public void onRenderHUD(RenderGameOverlayEvent.Pre event) {
		...
		if(event.type == ElementType.HOTBAR && (ModEventHandlerClient.flashTimestamp + (ModEventHandlerClient.flashDuration+ModEventHandlerClient.asteroidflashDuration) - System.currentTimeMillis()) > 0) {
			double mult = (ModEventHandlerClient.flashTimestamp + (ModEventHandlerClient.flashDuration+ModEventHandlerClient.asteroidflashDuration) - System.currentTimeMillis()) / (double) (ModEventHandlerClient.flashDuration+ModEventHandlerClient.asteroidflashDuration) * 2;
