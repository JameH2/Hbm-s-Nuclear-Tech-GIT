...
public class EntityTankbot extends EntityMob implements IRadiationImmune, ISuffocationImmune {

	public double headTargetYaw;

	private static final IEntitySelector selector = new IEntitySelector() {
		public boolean isEntityApplicable(Entity entity) {
			return !(entity instanceof EntityTankbot);
		}
	};

	public EntityTankbot(World world) {
		super(world);
