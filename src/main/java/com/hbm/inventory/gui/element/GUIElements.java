...
public class GUIElements {
	...
	/*
	public static void drawSmoothTextureModalCircle(int xDraw, int yDraw, int xStart, int yStart, int xDelta, int yDelta, double progress) {
		drawSmoothTextureModalCircle(xDraw, yDraw, xStart, yStart, xDelta, yDelta, progress);
	}
	 */
