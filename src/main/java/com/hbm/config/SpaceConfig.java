...
public class SpaceConfig {
	...
	public static int walDimension = 413_026;
	...
	public static int walBiome = 127;
	...
	public static void loadFromConfig(Configuration config) {
		...
		walDimension = CommonConfig.createConfigInt(config, CATEGORY_DIM, "17.11_walDimension", "Wal dimension ID", walDimension);
		...
		walBiome = createConfigBiome(config, CATEGORY_BIOME, "16.33_walBiome", "Wal Biome ID", walBiome + defaultBiomeOffset);
	}
