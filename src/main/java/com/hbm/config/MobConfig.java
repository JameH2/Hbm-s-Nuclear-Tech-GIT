...
public class MobConfig {
	...
	public static boolean enableBrineSlime = true;
	...
	public static void loadFromConfig(Configuration config) {
		...
		enableBrineSlime = CommonConfig.createConfigBool(config, CATEGORY, "12.D03_enableBrineSlime", "Whether Brine Slime should spawn on Wal", true);
