...
public abstract class GenLayerPlock extends GenLayer
{
    public GenLayerPlock(long l)
    {
        super(l);
    }
    ...
    public static GenLayer[] makeTheWorld(long l)
    {
    	...
    	GenLayer biomes = new GenLayerPlockBiomes(l);
    	 biomes = new GenLayerFuzzyZoom(2000L, biomes);
         biomes = new GenLayerZoom(2001L, biomes);
         biomes = new GenLayerDiversifyPlock(1000L, biomes);
         biomes = new GenLayerZoom(1000L, biomes);
         biomes = new GenLayerDiversifyPlock(1001L, biomes);
         biomes = new GenLayerZoom(1001L, biomes);
         biomes = new GenLayerPlockLowlands(1300L, biomes);
