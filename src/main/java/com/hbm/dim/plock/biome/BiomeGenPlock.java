...
public class BiomeGenPlock extends BiomeGenBase {
	
    public static final BiomeGenBase.Height height = new BiomeGenBase.Height(0.125F, 0.25F);

    //TODO: avoid doing an extra planets and make each planet unique and cool.
	public BiomeGenPlock(int id) {
		super(id);
		this.setBiomeName("Plock Icy Wastes");
		this.setDisableRain();
                    ...
                    if (block2 == ModBlocks.plock_ice)
                    {
                        if (k == -1)
                        {
                            ...
                            else if (l1 < 62)
                            {
                                ...
                                {
                                    blocks[i2] = ModBlocks.plock_tholinated_ice;   	
                                }
                            }
                            else
                            {
