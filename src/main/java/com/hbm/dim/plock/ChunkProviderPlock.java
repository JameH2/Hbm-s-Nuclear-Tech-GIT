...
public class ChunkProviderPlock implements IChunkProvider
{
    /** RNG. */
    ...
    public ChunkProviderPlock(World par1World, long seed, boolean mapFeaturesEnabled)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
							...
							for (int k3 = 0; k3 < 4; ++k3)
							{
								...
								{
									p_147424_3_[j3 += short1] = ModBlocks.ln2_block;
								}
								else if (k2 * 8 + l2 == b0)
								{
									p_147424_3_[j3 += short1] = ModBlocks.plock_tholinated_ice;
								}
								else
								{
