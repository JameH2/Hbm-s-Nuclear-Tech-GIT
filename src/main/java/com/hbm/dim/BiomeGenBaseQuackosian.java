...
public class BiomeGenBaseQuackosian extends BiomeGenBase
{
    public static final BiomeGenBase crater = new BiomeGenCrater(SpaceConfig.impactCrater).setTemperatureRainfall(1.0F, 0.0F);
    ...
    public BiomeGenBaseQuackosian(int id)
    {
        super(id);
    }
}