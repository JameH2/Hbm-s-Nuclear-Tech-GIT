			...
			.withSatellites(
				...
				new CelestialBody("neidon")
					...
					new CelestialBody("thatmo", SpaceConfig.thatmoDimension, Body.THATMO)
						...
						.withBlockTextures("textures/blocks/snow.png", "textures/blocks/snow.png")
						.withIce(true),
		...
		demeter = new CelestialBody("demeter")
			...
			.withSatellites(
				...
				new CelestialBody("dima", SpaceConfig.dimaDimension, Body.DIMA)
					...
					.withBlockTextures(RefStrings.MODID + ":textures/blocks/ike_stone.png", RefStrings.MODID + ":textures/blocks/dima_regolith.png")
